...
export default function Library() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center bg-black text-zinc-300 px-4">
      <BookOpen className="w-24 h-24 text-emerald-500 mb-8 opacity-50" />
      <h1 className="text-5xl font-bold text-white mb-4 uppercase tracking-wider">Library</h1>
      <p className="text-xl text-zinc-400 mb-8 font-light text-center max-w-2xl">
        A curated collection of historical documents, technical papers, and multimedia resources.
      </p>
