...
export default function Glossary() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center bg-black text-zinc-300 px-4">
      ...
      <h1 className="text-5xl font-bold text-white mb-4 uppercase tracking-wider">Glossary</h1>
      <p className="text-xl text-zinc-400 mb-8 font-light text-center max-w-2xl">
        A comprehensive dictionary of aerospace terminology, acronyms, and technical concepts.
      </p>
